    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="{{route('admin.Index')}}"><i class="fa fa-link"></i> <span>Dashboard</span></a></li>
                <li><a href="{{route('blog.index')}}"><i class="fa fa-book"></i> <span>Blog</span></a></li>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-adjust"></i> <span>Yönetim</span>
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{route('setting.Index')}}"><i class="fa fa-cog"></i> <span>Ayarlar</span></a></li>
                    </ul>
                </li>
            </ul>
            <!-- /.sidebar-menu -->
